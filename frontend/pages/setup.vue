      ...
      <div class="card card-md">
        <div v-if="firstSetup">
          <div class="card-body text-center py-2 p-sm-5">
            ...
            <p class="text-muted">
              On LoL Stats you can compare your player stats and achievements with all League of legends players over the world or just with your friends.
            </p>
          </div>
        </div>
      ...
      <div class="row align-items-center mt-3">
        <div class="col">
          <div class="btn-list justify-content-end">
            <NuxtLink v-if="!firstSetup" to="/dashboard" class="btn btn-link link-secondary">
              Cancel
            </NuxtLink>
            <button class="btn btn-primary" @click="setPlayerName()">Continue</button>
          </div>
        </div>
      </div>
    </div>
