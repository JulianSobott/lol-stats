                    ...
                    <div class="empty">
                      ...
                      <div class="mb-2">
                        ...
                        <p class="empty-subtitle text-muted">
                          There is no player data in our system that could be
                          compared to your filter. Please try another filter.
                        </p>
                      </div>
                    </div>
                  </div>
                        ...
                        <tbody>
                          ...
                          >
                            ...
                            <td>
                              <span
                                :class="
                                  getCompareColor(achievement.you.max.compare)
                                "
                                >{{
                                  formatFloat(achievement.you.max.value)
                                }}</span
                              >
                              <span class="text-muted">/</span>
                              <span
                                :class="
                                  getCompareColor(achievement.you.avg.compare)
                                "
                                >{{
                                  formatFloat(achievement.you.avg.value)
                                }}</span
                              >
                              <span class="text-muted">/</span>
                              <span
                                :class="
                                  getCompareColor(achievement.you.total.compare)
                                "
                                >{{
                                  formatFloat(achievement.you.total.value)
                                }}</span
                              >
                            </td>
                            <td>
                              <span
                                :class="
                                  getCompareColor(achievement.other.max.compare)
                                "
                                >{{
                                  formatFloat(achievement.other.max.value)
                                }}</span
                              >
                              <span class="text-muted">/</span>
                              <span
                                :class="
                                  getCompareColor(achievement.other.avg.compare)
                                "
                                >{{
                                  formatFloat(achievement.other.avg.value)
                                }}</span
                              >
                              <span class="text-muted">/</span>
                              <span
                                :class="
                                  getCompareColor(
                                    achievement.other.total.compare
                                  )
                                "
                                >{{
                                  formatFloat(achievement.other.total.value)
                                }}</span
                              >
                            </td>
                            <td>
