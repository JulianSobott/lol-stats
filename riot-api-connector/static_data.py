...
def update_champions(db: db, clear: bool = False):
    if clear:
        db.clear_champions()
...
def update_summoner_spells(db: db, clear: bool = False):
    if clear:
...
def update_items(db: db, clear: bool = False):
    if clear:
        db.clear_items()
...
def update_summoner_icons(db: db, clear: bool = False):
    if clear:
