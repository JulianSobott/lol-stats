...
def setup_challenges(db_session: Session):
    challenges = [
        ChallengeClasses(name=challenge_1, class_name=category_1, comparison_operator=">"),
        ChallengeClasses(name=challenge_2, class_name=category_2, comparison_operator="<"),
    ]
