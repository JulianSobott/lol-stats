...
def test_get_most_played(db_session):
    ...
    assert data.most_played[0].champion_id == Champion("Lux").id
    assert data.most_played[0].games == 10
    assert data.most_played[0].win_rate == calc_win_rate(10, 4)
    assert data.most_played[1].champion_id == Champion("Azir").id
    assert data.most_played[1].games == 5
    assert data.most_played[1].win_rate == calc_win_rate(5, 5)
    assert data.most_played[2].champion_id == Champion("Annie").id
    assert data.most_played[2].games == 4
    assert data.most_played[2].win_rate == calc_win_rate(4, 0)
    assert data.most_played[3].champion_id == Champion("Thresh").id
    assert data.most_played[3].games == 3
    assert data.most_played[3].win_rate == calc_win_rate(3, 0)
